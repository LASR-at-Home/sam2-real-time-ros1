...
# SAM 2.1 checkpoints
for filename in "sam2.1_hiera_tiny.pt" "sam2.1_hiera_small.pt" "sam2.1_hiera_base_plus.pt" "sam2.1_hiera_large.pt"; do
...
echo "All checkpoints are downloaded successfully or already present."
